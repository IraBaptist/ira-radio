const CACHE='ira-radio-v1.5.3';
const ASSETS=['./','./index.html','./styles.css?v=1530','./app.js?v=1530','./manifest.json','./public.html','./public.css?v=1530','./public.js?v=1530','./config.js'];
